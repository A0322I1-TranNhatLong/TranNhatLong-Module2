package Exam_md2.services;

import Exam_md2.models.GeneralRecord;
import Exam_md2.models.MedicalRecord;
import Exam_md2.models.VipRecord;
import Exam_md2.untils.NotFoundMedicalRecordException;
import Exam_md2.untils.ReadAndWriteCSV;
import Exam_md2.validate.Validate;
...
public class MedicalRecordsServiceImpl implements MedicalRecordsService {
    ...
    public void add() throws Exception {
        ...
        String patienCode = getPatientCode();
        String patienName = getName();
        LocalDate inDate;
        LocalDate outDate;
        while (true) {
            inDate = getInDate();
        ...
        while (true) {
            try {
                ...
                switch (choice) {
                    case 1:
                        int fee = getFee();
                        medicalRecord = new GeneralRecord(serial, medicalCode, patienCode, patienName, inDate, outDate, reason, fee);
                        break;
                    case 2:
                        String type = getType();
                        LocalDate duration = getDuration();
                        medicalRecord = new VipRecord(serial, medicalCode, patienCode, patienName, inDate, outDate, reason, type, duration);
                        break;
                    default:
                ...
                System.out.println("Phải chọn 1 đến 3 ! ");
    ...
    private String getPatientCode() {
        while (true) {
            ...
            String code = SCANNER.nextLine();
            if (Validate.isPatienCodeRight(code)) {
                return code;
            }
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 3:
                        return "VIP III";
                    default:
                        System.out.println("Bạn phải chọn 1 trong 3 ! ");
                }
            } catch (NumberFormatException e) {
